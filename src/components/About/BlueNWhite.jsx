...
via-[#3b0f2a]
to-[#000000]
 text-white py-10 sm:py-14 md:py-20 px-4 sm:px-6 md:px-8 lg:px-16"
      >
            ...
            <div className="w-full lg:w-1/2 order-2 lg:order-1">
              ...
              >
                <div className="flex items-center gap-3 mb-6 relative">
                  <ScrollReveal
                    animation="slightspinFromLeft"
                    duration={1000}
                    delay={300}
                    easing="spring"
                    disableBelow="lg"
                  >
                    <div className="text-7xl md:text-8xl opacity-20 font-bold text-red-600 absolute -bottom-[9px] md:-bottom-5 left-0">
                      {missionNumber}
                    </div>
                  </ScrollReveal>
                  <ScrollReveal
                ...
                {missionPoints.map((point, index) => (
                  ...
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      >
                        <div
                          className={`bg-red-900 rounded-full h-8 w-8 sm:h-10 sm:w-10 flex items-center justify-center text-white font-bold shrink-0 border-2 border-red-700 ${
                            noPoints ? `hidden` : `block`
                          }`}
                        >
                          {index + 1}
                        </div>
              ...
              >
                <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:w-[24rem] mx-auto relative">
                  ...
                  <img
                    src={missionImage}
                    alt="Mission"
                    className="w-full h-auto rounded-lg relative z-10 border-2 border-red-700 shadow-lg"
                  />
                </div>
              </ScrollReveal>
            </div>
      ...
      <div
        className={`bg-white py-10 sm:py-14 md:py-20 px-4 sm:px-6 md:px-8 lg:px-16 ${
          visionHidden ? "hidden" : "block"
        }`}
      >
            ...
            >
              <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:w-[24rem] relative">
                ...
                <img
                  src={visionImage}
                  alt="Vision"
                  className="w-full h-auto rounded-lg relative z-10 border-2 border-gray-200 shadow-xl "
                />
              </div>
            </ScrollReveal>
              ...
              >
                <div className="flex items-center gap-3 mb-6 relative">
                  <ScrollReveal
                    ...
                    disableBelow="md"
                  >
                    <div className="text-7xl md:text-8xl opacity-15 font-bold text-red-600 absolute -bottom-[9px] md:-bottom-5 left-0">
                      {visionNumber}
                    </div>
                  </ScrollReveal>
                  <ScrollReveal
                  ...
                  >
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 relative">
                      ...
                      {visionTitle.split(" ").slice(1).join(" ")}
                    </h2>
                  </ScrollReveal>
                </div>
              </ScrollReveal>
                ...
                {visionPoints.map((point, index) => (
                  ...
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      >
                        <div
                          className={`bg-black rounded-full h-8 w-8 sm:h-10 sm:w-10 flex items-center justify-center text-white font-bold shrink-0 border-2 border-red-500 ${
                            noPoints ? `hidden` : `block`
                          }`}
                        >
                          {index + 1}

  ...
  <button className="col-span-2 w-full bg-white text-red-800 font-bold py-2 sm:py-3 text-sm sm:text-base rounded-lg hover:bg-gray-100 transition duration-300">
    Talk To Career Counsellor
          ...
          <div className="flex flex-col sm:grid grid-cols-[2fr_1fr] grid-rows-[auto_1fr_auto] md:grid-cols-[1fr] lg:grid-cols-[1fr_1fr] xl:grid-cols-[1fr_200px] gap-4 bg-gradient-to-b from-black via-red-800 to-red-900 text-white rounded-lg shadow-xl sm:w-full md:w-1/2 p-4 sm:p-6 border-2 sm:border-4 border-red-900">
            {/* Title - spans full width */}
            <h2 className="text-xl sm:text-2xl font-bold mb-2 col-span-2 capitalize">
              {props.courseName} Program + Project Certificate
            </h2>
            ...
            <div className="flex flex-col">
              <ul className="space-y-2 sm:space-y-3 mb-auto">
                ...
                <li className="flex items-start sm:items-center">
                  ...
                  >
                    <svg
                      className="w-4 h-4 sm:w-5 sm:h-5 mr-2 mt-0.5 sm:mt-0 text-green-400 flex-shrink-0"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path

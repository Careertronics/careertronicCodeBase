...
function page() {
  const faqData = {
    General: [
      {
        id: 1,
        question: "Who can enroll in this Data Analytics course?",
        answer:
    ...
    Features: [
      {
        ...
        answer:
          "You will gain hands-on experience with Excel (advanced), SQL, Python (Pandas, NumPy, Matplotlib), Power BI, and Tableau — all widely used in modern data analytics and business intelligence environments.",
      },
      {
        id: 8,
        question: "How will I access the required software?",
        answer:
          "Most tools used in the course are open-source or offer free/community editions. We provide guided setup instructions and cloud-based practice environments where applicable.",
      },
      {
        id: 9,
        question: "What real-world applications are covered?",
        answer:
          "You will work on practical projects such as sales performance analysis, customer segmentation, KPI dashboards, forecasting models, and business reporting simulations.",
      },
    ],
  ...
  const courses1 = [
    ...
    { title: "Business & Statistical Foundations" },
    { title: "Introduction to Data Analytics" },
    { title: "Exploratory Data Analysis (EDA)" },
  ];

  const courses2 = [
    { title: "Excel for Data Analysis – Basics" },
    { title: "Excel for Data Analysis – Advanced" },
  ...
  const courses3 = [
    ...
    { title: "Tableau – Reporting & Dashboards" },
    { title: "Advanced Tableau Analytics" },
  ...
  const courses4 = [
    ...
    { title: "DAX & Advanced Calculations" },
  ];
  ...
  const courses5 = [
    ...
    { title: "Capstone Projects & Case Studies" },
  ];
          ...
          <div className="left h-fit xl:w-1/2 w-full xl:px-24 xl:py-20 p-4 flex flex-col gap-10 items-start">
            <ScrollReveal animation="slightRight" delay={100} easing="gentle">
              <div className="rounded-3xl border-2 sm:text-base text-xs border-white md:w-max sm:text-left text-center w-auto sm:px-10 sm:py-2 p-2 font-bold bg-black uppercase">
                ONLINE & OFFLINE Data Analytics COURSE
              </div>
            </ScrollReveal>
            <ScrollReveal animation="fadeIn" delay={300} easing="spring">
              <h1 className="xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-2xl font-bold">
                ...
                <span className="text-red-600 capitalize">Data Analytics</span>
              </h1>
            </ScrollReveal>
            <ScrollReveal animation="slideUp" delay={500} easing="smooth">
              <p className="lg:text-xl sm:text-lg tracking-wide">
                Data Analytics is a course that focuses on examining raw data to
                uncover patterns, draw conclusions, and support decision-making.
                It covers key areas such as statistical analysis, data
                visualization, predictive modeling, and business intelligence.
                The course equips learners with the knowledge and tools to
                collect, process, and interpret complex datasets, extract
                meaningful insights, and communicate findings effectively to
                drive strategic actions across various organizational contexts.
              </p>
            </ScrollReveal>
            <ScrollReveal
              animation="scaleUp"
            ...
            >
              ...
              <Button
                ...
                download="Data Analytics Program.pdf"
                link="/brochure/Data Analytics Program.pdf"
              />
            </ScrollReveal>
          </div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center px-6 md:px-10 lg:px-16">
          <ScrollReveal animation="fadeIn" delay={200} easing="smooth">
            <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-center text-white leading-tight capitalize mb-16">
              How Can We Turn You Into A Expert Data Analyst ?
            </h1>
          </ScrollReveal>

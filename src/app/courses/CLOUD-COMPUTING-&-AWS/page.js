...
function page() {
  const faqData = {
    General: [
      {
        id: 1,
        question: "Who can enroll in this Cloud Computing course?",
        answer:
          "This course is ideal for students, developers, system administrators, IT professionals, and anyone interested in building a career in cloud technologies. It starts from core fundamentals and progresses to advanced cloud deployment concepts.",
      },
      {
        id: 2,
        question: "What topics are covered in the course?",
        answer:
          "The program covers cloud computing fundamentals, virtualization, cloud architecture, networking, storage, security, and deployment models. You will work with leading cloud platforms, infrastructure services, automation tools, and monitoring systems.",
      },
      {
        id: 3,
        question: "What practical skills will I gain?",
        answer:
          "You will learn how to design, deploy, and manage scalable cloud infrastructure, configure storage and networking, automate deployments, implement security best practices, and monitor cloud-based applications.",
      },
      {
        id: 4,
        question: "How does this course improve job prospects?",
        answer:
          "The curriculum is aligned with industry standards and includes real-world projects, cloud deployment scenarios, and interview preparation support, helping you qualify for roles such as Cloud Engineer, Infrastructure Engineer, and DevOps Associate.",
      },
    ],
    ...
    Pricing: [
      ...
      },
      {
        ...
        answer:
          "Yes, we provide early-bird benefits, student discounts, and seasonal offers from time to time. Connect with our team to know about current promotions.",
      },
    ],
    ...
    Features: [
      {
        ...
        answer:
          "You will gain hands-on experience with leading cloud platforms, compute and storage services, networking tools, monitoring systems, infrastructure automation tools, and container technologies widely used in enterprise environments.",
      },
      {
        id: 8,
        question: "How will I practice cloud deployments?",
        answer:
          "We guide you in setting up cloud accounts and provide structured lab exercises and project-based learning so you can practice on real cloud environments.",
      },
      {
        id: 9,
        question: "What real-world applications are covered?",
        answer:
          "You will work on practical scenarios such as deploying scalable web applications, implementing load balancing, automating infrastructure provisioning, configuring cloud security, and setting up monitoring dashboards.",
      },
    ],
  ...
  const courseDesc = [
    {
      ...
      description:
        "Be job-ready for roles like SRE, Platform Engineer, and Infrastructure Engineer with this DevOps and AWS certification course, tailored to boost your career in the cloud industry.",
    },
    {
  ...
  const courses1 = [
    ...
    { title: "Cloud Service Models & Deployment Models" },
    { title: "AWS Global Infrastructure Overview" },
    { title: "Compute Services & Amazon Machine Images (AMI)" },
  ];
  ...
  const courses2 = [
    ...
    { title: "Introduction to Cloud Security Principles" },
  ];
  ...
  const courses5 = [
    ...
    { title: "Cost Management & Billing Optimization" },
  ...
  const courses6 = [
    ...
    { title: "Capstone Project – End-to-End Cloud Deployment" },
  ];
  const skills = [
    "AWS",
    "Azure",
          ...
          <div className="left h-fit xl:w-1/2 w-full xl:px-20 xl:py-16 p-4 flex flex-col gap-10 items-start">
            <ScrollReveal animation="slightRight" delay={100} easing="gentle">
              <div className="rounded-3xl border-2 sm:text-base text-xs border-white md:w-max sm:text-left text-center w-auto sm:px-10 sm:py-2 p-2 font-bold bg-black uppercase">
                ONLINE & OFFLINE CLOUD COMPUTING(AWS) COURSE
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal animation="slideUp" delay={500} easing="smooth">
              <p className="lg:text-xl sm:text-lg tracking-wide">
                This Cloud Computing(AWS) course introduces the fundamentals of
                delivering computing services over the internet, focusing on
                virtualization, cloud service models (IaaS, PaaS, SaaS),
                deployment models (public, private, hybrid), and cloud
                architecture. It dives deep into AWS, offering hands-on
                experience in deploying, managing, and securing cloud-based
                applications and infrastructure using services like EC2, S3, and
                IAM.
              </p>
            </ScrollReveal>
            <ScrollReveal
                ...
                <div className="h-full flex-1 px-3 gap-5 flex flex-row sm:flex-col shrink-0 justify-between sm:justify-around">
                  ...
                  <div className="sm:border-r-4 flex items-center">
                    <p className="font-bold text-lg md:text-2xl">
                      <span className="text-3xl">5</span> Months
                    </p>
                  </div>
                </div>
                <div className="h-full flex-1 px-3 gap-5 flex flex-row sm:flex-col shrink-0 justify-between sm:justify-around">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center px-6 md:px-10 lg:px-16">
          <ScrollReveal animation="fadeIn" delay={200} easing="smooth">
            <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-center text-white leading-tight capitalize mb-16">
              How Can We Turn You Into A Cloud Computing Expert?
            </h1>
          </ScrollReveal>
        ...
        <div>
          ...
          <CourseRoadmap
            ...
            texts={{
              ...
              subHeading:
                "Covering all modules above makes you ready to apply for cloud computing roles",
            }}
          />

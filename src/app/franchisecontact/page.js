                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                      <div>
                        ...
                        <select
                          ...
                          value={formData.city}
                          onChange={handleChange}
                          className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-red-500"
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          placeholder="e.g. Graduate / Postgraduate / Diploma"
                          className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-red-500"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          placeholder="e.g. 5+ years in business / IT / education"
                          className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-red-500"
                        />
                      </div>
                    </div>
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              >
                <div className="bg-gray-900/40 backdrop-blur-sm p-6 md:p-8 rounded-xl border border-gray-800 shadow-xl relative overflow-hidden">
                  ...
                  <p className="text-xl  mb-4 relative">
                    Join Careertronic Skill & Technology Centre and be part of a
                    future-focused technology education movement.
                  </p>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-white">+91-9685995547</p>
                    </div>
                  </div>
                  <div className="flex items-start ">
                    <div className="flex-shrink-0 h-10 w-10 rounded-full bg-red-600/20 flex items-center justify-center mr-3">
